...
public class Demo1 {
    ...
    public static void main(String[] args) {
        ...
        ExtentTest testCase1 = suite1.createNode("Valid Login Test").assignAuthor("Dat Le").assignDevice("PC");
        ExtentTest testCase2 = suite2.createNode("Admin Dashboard Test").assignCategory("Smoke").assignAuthor("Phoebe");
